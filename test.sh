...
assert  2 'int main() { if(true) { return 2; } else { return 3; } }'
assert  2 'int main() { bool t=true; if(t) { return 2; } else { return 3; } }'
assert  3 'int main() { bool f=false; if(f) { return 2; } else { return 3; } }'
...
assert  5 'int main() { int i=0; do { i=i+1; } while(i<5); return i; }'
assert 42 'int main() { int i; do { i=42; } while(false); return i; }'
assert 42 'int main() { do { return 42; } while(true); return 0; }'
...
assert  4 'int main() { bool i=({ 1==1; }); if(i) return 4; return 5; }'
