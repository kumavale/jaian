...
assert  8 '{ int foo_123=3, bar=5; return foo_123+bar; }'
...
assert  4 '{ int i=5; int j=0; while(i=i-1) j=j+1; return j; }'
assert  1 '{ while(0) return 0; return 1; }'
assert 55 '{ int i=0; int j=0; while(i<=10) {j=i+j; i=i+1; } return j; }'

assert 10 '{ int j=0; for(int i=0; i<5; i=i+1) j=j+i; return j; }'
assert 42 '{ for(int i=42; i<100; i=i+1) return i; return 21; }'
assert 42 '{ for(int i=42, j; 1;) { j = i; return j; } return 21; }'
